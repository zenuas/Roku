...
public static partial class Definition
{
    ...
    public static void IfThenDefinition(ILexicalScope scope, IIfNode if_, LabelCode next_label)
    {
        ...
        {
            inner_scope.Body.Add(new IfCode { Condition = NormalizationExpression(inner_scope, ifn.Condition, true), Else = next_label });
        }
        ...
        else
        {
            ...
            inner_scope.Body.Add(new Call { Function = new FunctionCallValue { Function = new VariableValue { Name = "isnull" } }.Return(x => x.Arguments.Add(cond)), Return = _v0 });
